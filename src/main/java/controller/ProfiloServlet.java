...
public class ProfiloServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //controllo di se si sta visualizzando il profilo di un altro utente oppure il proprio
        String idParam = request.getParameter("id");
        int idProfiloDaVisualizzare;

        if (idParam != null && !idParam.isEmpty()) {
            //caso in cui si sta visualizzando il profilo di un altro utente
            idProfiloDaVisualizzare = Integer.parseInt(idParam);
        } else {
            //caso in cui si sta visualizzando il proprio profilo
